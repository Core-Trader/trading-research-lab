...
import { DEFAULT_THRESHOLDS, type ResearchPreferences, type ThresholdStore } from "../application/research-settings";
...
export function useThresholds(): [ResearchPreferences, (next: Partial<ResearchPreferences>) => void] {
