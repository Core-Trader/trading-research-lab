...
def markdown_summary(statistics: dict[str, object]) -> str:
    ...
    lines = [
        ...
        "- Balance curve: `VERIFIED` from source-reported balances.",
        "- Source quality: `MT5_VERIFIED` for retained deal facts; no trade pairing is claimed.",
        "- Equity curve: `UNAVAILABLE`; no mark-to-market reconstruction was performed.",
        "",
        "### M0 limitations",
        "",
