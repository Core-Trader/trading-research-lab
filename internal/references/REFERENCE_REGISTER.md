...
| MT5 Help, "Trading Report": https://www.metatrader5.com/en/terminal/help/trading_advanced/history_report | Margin Level = Equity / Margin × 100; equity includes open positions; margin is the funds required to keep positions open. The page does not define margin-call or stop-out levels (broker settings) | Read 2026-09-24 |
| MT5 Help, "Market Watch" (Specification): https://www.metatrader5.com/en/terminal/help/trading/market_watch | The contract specification shows the spread in points ("floating" when floating), contract size (units per lot), tick size ("minimum price change step"), tick value ("cost of a single price change point"), swaps, and commission (charged on the deal or at the end of a day/month) | Read 2026-09-24 |
| MT5 Help, "Strategy Testing" (delays): https://www.metatrader5.com/en/terminal/help/algotrading/testing | Delays between the request and its execution, during which the price can change; zero delay executes at the requested prices; random delay 0–18 s (90 % 0–8 s, 10 % 9–18 s); fixed or custom delay; applies to EA trade requests (for pending orders, to placing, not to execution) | Read 2026-09-24 |
| Obsidian Help, "Basic formatting syntax" (task lists): https://obsidian.md/help/syntax | "- [ ]" is an incomplete task, "- [x]" a completed one; any character inside the brackets marks a task complete (for example [?] or [-]) | Read 2026-09-25 |
